...
# use, hence lacks any of noticable futures - still better than nothing
...
user_mail = "kotrfa@gmail.com"
path = "/home/dan/.local/share/data/Mendeley Ltd./Mendeley Desktop/{0}@www.mendeley.com.sqlite".format(user_mail)
